...
export const gunlukEkle = async (
  ...
  try {
    const response = await axios.post(
      `/ekle/${urun}/${personel_sayisi}/${hedeflenen}/${ulasilan}/${atilan}/${tarih}`
    );
    return {
      data: response.data,
      error: null,
...
export const gunlukDuzenle = async (
  urun,
  yeni_urun,
  yeni_personel_sayisi,
  yeni_hedeflenen,
  yeni_ulasilan,
  yeni_atilan,
  yeni_tarih
  ...
  try {
    const response = await axios.put(
      `/duzenle/${urun}/${yeni_urun}/${yeni_personel_sayisi}/${yeni_hedeflenen}/${yeni_ulasilan}/${yeni_atilan}/${yeni_tarih}`
    );
    return {
      data: response.data,
      error: null,
