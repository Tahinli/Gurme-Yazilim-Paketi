...
const kategorigir = (await kategoriApi.getKategoriler()).map(
...
export default function DContainer() {
  ...
  for (let urun of Urunler) {
    if (urun.kategori_isim === kategoriadi) urungir.push(urun.isim);
  }
  ...
  const handleClick = async () => {
    ...
    if (
      !(
        urunadi === null ||
        urunadi === undefined ||
        (urunadi === "" && kategoriadi === null) ||
        kategoriadi === undefined ||
        kategoriadi === ""
      )
    ) {
